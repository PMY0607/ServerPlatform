      ...
      <el-form :inline="true" :model="searchForm" class="form-content">
        <el-row :gutter="20" class="slt"
          ...
          <el-form-item class="select" label="班级" prop="clazz">
            <el-select @change="clazzChange" clearable v-model="searchForm.clazz"
                       placeholder="请选择班级">
              <el-option
      ...
      <div class="table-content">
        <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
          ...
          <el-table-column width="300" :align="contents.tableAlign"
            ...
            <template slot-scope="scope">
              <el-button
                  v-if="isAuth('clazzNotice','查看') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 1"
              ...
              <el-button
                  v-if="isAuth('clazzNotice','查看') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 2"
              ...
              <el-button v-if="isAuth('clazzNotice','查看') && contents.tableBtnIcon == 0"
              ...
              <el-button
                  v-if=" isAuth('clazzNotice','修改') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 1"
              ...
              <el-button
                  v-if=" isAuth('clazzNotice','修改') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 2"
              ...
              <el-button v-if=" isAuth('clazzNotice','修改') && contents.tableBtnIcon == 0"
                         type="primary" size="mini" @click="addOrUpdateHandler(scope.row.id)">
                {{ contents.tableBtnFont == 1 ? '修改' : '' }}
              </el-button>
              ...
              <el-button
                  v-if="isAuth('clazzNotice','删除') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 1"
                  type="danger" icon="el-icon-delete" size="mini"
                  @click="deleteHandler(scope.row.id)">{{ contents.tableBtnFont == 1 ? '删除' : '' }}
              </el-button>
              <el-button
                  v-if="isAuth('clazzNotice','删除') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 2"
              ...
              <el-button v-if="isAuth('clazzNotice','删除') && contents.tableBtnIcon == 0"
                         type="danger" size="mini" @click="deleteHandler(scope.row.id)">
