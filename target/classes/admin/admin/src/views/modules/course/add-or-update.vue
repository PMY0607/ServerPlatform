<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="班级" prop="clazz">
          <el-select :disabled="ro.clazz" v-model="ruleForm.clazz" placeholder="请选择班级">
            <el-option
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="课程名称" prop="courseName">
          <el-input v-model="ruleForm.courseName"
              placeholder="课程名称" clearable  :readonly="ro.courseName"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="课程名称" prop="courseName">
              <el-input v-model="ruleForm.courseName"
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="科目名称" prop="subjectName">
          <el-input v-model="ruleForm.subjectName"
              placeholder="科目名称" clearable  :readonly="ro.subjectName"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="科目名称" prop="subjectName">
              <el-input v-model="ruleForm.subjectName"
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="开课时间" prop="startTime">
            <el-date-picker
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.startTime" label="开课时间" prop="startTime">
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="结束时间" prop="endTime">
            <el-date-picker
                value-format="yyyy-MM-dd HH:mm:ss"
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.endTime" label="结束时间" prop="endTime">
      ...
      <el-col :span="24">  
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.cover" label="封面" prop="cover">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.cover.split(',')" :src="$base.url+item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'" label="教师账号" prop="teacherUsername">
          <el-select :disabled="ro.teacherUsername" @change="teacherUsernameChange" v-model="ruleForm.teacherUsername" placeholder="请选择教师账号">
            <el-option
                v-for="(item,index) in teacherUsernameOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input"v-if="ruleForm.teacherUsername" label="教师账号" prop="teacherUsername">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="课程内容" prop="content">
                <editor 
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.content" label="课程内容" prop="content">
...
export default {
  ...
  created() {
	this.ruleForm.startTime = this.getCurDateTime()

	this.ruleForm.endTime = this.getCurDateTime()
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.courseName = true;
          ...
          if(o=='subjectName'){
            this.ruleForm.subjectName = obj[o];
	    this.ro.subjectName = true;
            continue;
          }
          if(o=='startTime'){
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
            ...
            this.$http({
              ...
              if (data && data.code === 0) {
                this.teacherUsernameOptions = data.data;
              } else {
                this.$message.error(data.msg);
              }
            });
    ...
    // 下二随
    teacherUsernameChange () {
      this.$http({
        url: `follow/teacher/username?columnValue=`+ this.ruleForm.teacherUsername,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
              if(data.data.name){
	...
	this.ruleForm.content = this.ruleForm.content.replace(reg,'../../../serverPlatform/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
