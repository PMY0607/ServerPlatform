<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="家长账号" prop="teacherUsername">
          <el-input v-model="ruleForm.teacherUsername"
              placeholder="家长账号" clearable  :readonly="ro.teacherUsername"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="家长账号" prop="teacherUsername">
              <el-input v-model="ruleForm.teacherUsername"
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info' && !ro.headPic" label="头像" prop="headPic">
          <file-upload
          tip="点击上传头像"
          action="file/upload"
          :limit="3"
          ...
          @change="headPicUploadChange"
          ></file-upload>
        </el-form-item>
        <div v-else>
          <el-form-item v-if="ruleForm.headPic" label="头像" prop="headPic">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.headPic.split(',')" :src="$base.url+item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="身份证" prop="idNumber">
          <el-input v-model="ruleForm.idNumber"
              placeholder="身份证" clearable  :readonly="ro.idNumber"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="身份证" prop="idNumber">
              <el-input v-model="ruleForm.idNumber"
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="住址" prop="address">
          <el-input v-model="ruleForm.address"
              placeholder="住址" clearable  :readonly="ro.address"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="住址" prop="address">
              <el-input v-model="ruleForm.address"
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.age = true;
          ...
          if(o=='headPic'){
            this.ruleForm.headPic = obj[o];
	    this.ro.headPic = true;
            continue;
          }
          if(o=='phone'){
		 ...
		 if(crossRefId && crossUserId) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `parent/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.parentCrossAddOrUpdateFlag = false;
						 this.parent.search();
