      ...
      this.$nextTick(()=>{
        document.querySelectorAll('.menulist .el-menu-item').forEach(el=>{
          ...
          el.addEventListener("mouseleave", e => {
            e.stopPropagation()
            // el.style.backgroundColor = "linear-gradient(135deg, rgba(255,178,150,1) 0%, rgba(255,178,150,1) 70%, rgba(95,174,208,1) 70%, rgba(95,174,208,1) 100%)"
...
<style lang="scss" scoped>
  ...
  .index-aside {
	...
	.menulist-item {
		...
		background: linear-gradient(135deg, rgba(255,178,150,1) 0%, rgba(255,178,150,1) 78%, rgba(95,174,208,1) 78%, rgba(95,174,208,1) 100%) !important;
		...
		& /deep/ .el-menu.el-menu--inline {
			...
			.el-menu-item {
                ...
                &.is-active {
                    ...
                    background-color: rgba(96, 175, 209, 1) !important;
                    box-shadow: 0 0 6px rgba(30, 144, 255, 0);
                    text-align: center;
                }
