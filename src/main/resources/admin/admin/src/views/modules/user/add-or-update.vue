<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="用户名" prop="teacherUsername">
          <el-input v-model="ruleForm.teacherUsername"
              placeholder="用户名" clearable  :readonly="ro.teacherUsername"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="用户名" prop="teacherUsername">
              <el-input v-model="ruleForm.teacherUsername"
