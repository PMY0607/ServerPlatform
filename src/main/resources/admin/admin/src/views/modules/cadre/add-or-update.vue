<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="名称" prop="position">
          <el-input v-model="ruleForm.position"
              placeholder="名称" clearable  :readonly="ro.position"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="名称" prop="position">
              <el-input v-model="ruleForm.position"
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="教师姓名" prop="teacherName">
          <el-input v-model="ruleForm.teacherName"
              placeholder="教师姓名" clearable  :readonly="ro.teacherName"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="教师姓名" prop="teacherName">
              <el-input v-model="ruleForm.teacherName"
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="任职原因" prop="reason">
                <el-input
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.reason" label="任职原因" prop="reason">
  ...
  methods: {
    ...
    init(id,type) {
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          var json = data.data;
		if(json.clazz!=''&&json.clazz){
                this.ruleForm.clazz = json.clazz
	    		this.ro.clazz = true;
		}
		...
		if(json.teacherName!=''&&json.teacherName){
		 ...
		 if(crossRefId && crossUserId) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `cadre/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.cadreCrossAddOrUpdateFlag = false;
						 this.parent.search();
