<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="学号" prop="stuNo">
          <el-input v-model="ruleForm.stuNo"
              placeholder="学号" clearable  :readonly="ro.stuNo"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="学号" prop="stuNo">
              <el-input v-model="ruleForm.stuNo"
