<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="发布时间" prop="updateTime">
            <el-date-picker
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.updateTime" label="发布时间" prop="updateTime">
      ...
      <el-col :span="24">  
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="简介" prop="briefIntr">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="简介"
                  v-model="ruleForm.briefIntr" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.briefIntr" label="简介" prop="briefIntr">
                    <span>{{ruleForm.briefIntr}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.title = true;
          ...
          if(o=='briefIntr'){
            this.ruleForm.briefIntr = obj[o];
	    this.ro.briefIntr = true;
            continue;
          }
          if(o=='updateTime'){
		 ...
		 if(crossRefId && crossUserId) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `schoolNotice/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.schoolNoticeCrossAddOrUpdateFlag = false;
						 this.parent.search();
