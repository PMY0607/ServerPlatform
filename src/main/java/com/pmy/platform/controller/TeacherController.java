...
public class TeacherController {
  ...
  public R login(String username, String password, String captcha, HttpServletRequest request) {
    TeacherEntity user = teacherService.selectOne(
        new EntityWrapper<TeacherEntity>().eq("username", username));
  ...
  public R register(@RequestBody TeacherEntity teacher) {
    ...
    TeacherEntity user = teacherService.selectOne(
        new EntityWrapper<TeacherEntity>().eq("username", teacher.getUsername()));
    if (user != null) {
  ...
  public R page(@RequestParam Map<String, Object> params, TeacherEntity teacher,
    ...
    PageUtils page = teacherService.queryPage(params,
        MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, teacher), params), params));
  ...
  public R query(TeacherEntity teacher) {
    EntityWrapper<TeacherEntity> ew = new EntityWrapper<TeacherEntity>();
    ew.allEq(MPUtil.allEQMapPre(teacher, "teacher"));
    TeacherEntityView teacherView = teacherService.selectView(ew);
